    ...
    var OppiaEmbed = (function () {
        function OppiaEmbed(oppiaNode) {
            ...
            if (oppiaNode.tagName !== 'OPPIA') {
                throw new Error('Expected OppiaEmbed to be defined using ' +
                    'a node of type <oppia>, not ' + oppiaNode.tagName);
            }
        ...
        OppiaEmbed.prototype.init = function () {
            ...
            if (autoload && autoload === 'false') {
                ...
                buttonContainer.setAttribute('style', 'margin: 10px auto; text-align: center');
            ...
            this.iframe.src = encodeURI(this.targetDomain + '/explore/' + this.oppiaNode.getAttribute('oppia-id') +
...
//# sourceMappingURL=oppia-player-0.0.1.js.map