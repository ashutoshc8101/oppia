...
(function (window, document) {
    ...
    var OppiaEmbed = (function () {
        ...
        var warningBoxStyle = ('background-color: #ddd; border-radius: 5px; margin: 1px auto; ' +
        ...
        OppiaEmbed.prototype.init = function () {
            ...
            if (!this.oppiaNode.getAttribute('oppia-id')) {
                ...
                spanTag.textContent = ('This Oppia exploration could not be loaded because no ' +
            ...
            this.iframe.src = encodeURI(this.targetDomain + '/embed/exploration/' +
            ...
            window.addEventListener('message', function (evt) {
                ...
                switch (data.title) {
                    case 'explorationLoaded':
                        ...
                        window.OPPIA_PLAYER.onExplorationLoaded(iframeNode, data.payload.explorationTitle);
                        break;
                    case 'heightChange':
                        window.OPPIA_PLAYER.onHeightChange(iframeNode, data.payload.height, data.payload.scroll);
                        break;
                    case 'stateTransition':
                        window.OPPIA_PLAYER.onStateTransition(iframeNode, data.payload.oldStateName, data.payload.jsonAnswer, data.payload.newStateName);
                        break;
                    case 'explorationReset':
                        ...
                        window.OPPIA_PLAYER.onExplorationReset(iframeNode, data.payload.stateName);
                        break;
    ...
    window.OPPIA_PLAYER = {
        ...
        onHeightChange: function (iframeNode, newHeight, doScroll) {
            _debug('onHeightChange event triggered on ' + iframeNode + ' for ' +
                newHeight);
        ...
        onExplorationLoaded: function (iframeNode, explorationTitle) {
            ...
            window.OPPIA_PLAYER.onExplorationLoadedPostHook(iframeNode, explorationTitle);
        },
        onStateTransition: function (iframeNode, oldStateName, jsonAnswer, newStateName) {
            window.OPPIA_PLAYER.onStateTransitionPostHook(iframeNode, oldStateName, jsonAnswer, newStateName);
        },
 ...
 */
window.OPPIA_PLAYER.onExplorationLoadedPostHook = function (iframeNode, explorationTitle) {
};
/**
 ...
 */
window.OPPIA_PLAYER.onStateTransitionPostHook = function (iframeNode, oldStateName, jsonAnswer, newStateName) {
};
/**
...
//# sourceMappingURL=oppia-player-0.0.3.js.map