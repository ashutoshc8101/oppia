...
(function () {
    ...
    for (var i = 0; i < SECRET_LENGTH; i++) {
        secret += alphanumericChars.charAt(Math.floor(Math.random() * alphanumericChars.length));
    }
    /**
    ...
    function reloadOppiaTag(oppiaNode) {
        ...
        iframe.setAttribute('src', encodeURI((oppiaNode.getAttribute('src') || currLoc) +
    ...
    window.OPPIA_PLAYER = {
        ...
        onExplorationLoaded: function (iframeNode) {
            ...
            var nodeToRemove = document.getElementById(oppiaNodeIdsToLoadingDivIds[nodeId]);
            if (nodeToRemove) {
...
//# sourceMappingURL=oppia-player-0.0.0.js.map