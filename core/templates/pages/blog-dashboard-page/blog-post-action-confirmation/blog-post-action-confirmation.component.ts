...
export class BlogPostActionConfirmationModalComponent
  ...
  isActionDelete(): boolean {
    if (
      this.blogPostAction === BlogDashboardPageConstants.BLOG_POST_ACTIONS.DELETE) {
        return true;
    } else {
        return false
    };
  ...
  isActionPublish(): boolean {
    if (
      this.blogPostAction === BlogDashboardPageConstants.BLOG_POST_ACTIONS.PUBLISH) {
        return true;
    } else {
        return false
    };
  ...
  isActionUnpublish(): boolean {
    if (
      this.blogPostAction === BlogDashboardPageConstants.BLOG_POST_ACTIONS.UNPUBLISH) {
        return true;
    } else {
        return false
    };
