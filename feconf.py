...
ROLE_ID_GUEST = constants.ROLES_DATA.ROLE_ID_GUEST
ROLE_ID_BANNED_USER = constants.ROLES_DATA.ROLES_ID_BANNED_USER
ROLE_ID_LEARNER = constants.ROLES_DATA.ROLES_ID_LEARNER
ROLE_ID_EXPLORATION_EDITOR = constants.ROLES_DATA.ROLE_ID_EXPLORATION_EDITOR
ROLE_ID_COLLECTION_EDITOR = constants.ROLES_DATA.ROLE_ID_COLLECTION_EDITOR
ROLE_ID_TOPIC_MANAGER = constants.ROLES_DATA.ROLE_ID_TOPIC_MANAGER
ROLE_ID_MODERATOR = constants.ROLES.ROLE_ID_MODERATOR
ROLE_ID_ADMIN = constants.ROLES.ROLE_ID_ADMIN

ALLOWED_USER_ROLES = constants.ROLES_DATA.ALLOWED_USER_ROLES
